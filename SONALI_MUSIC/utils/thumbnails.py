...
async def get_thumb(videoid: str):
    ...
    try:
        ...
        # Player overlay with white stroke
        player = Image.open("SONALI_MUSIC/assets/sona.png").convert("RGBA").resize((1280, 720))
        stroke = Image.new("RGBA", (player.width + 10, player.height + 10), (255, 255, 255, 0))
        stroke.paste(player, (5, 5), player)
        background.paste(stroke, (-5, -5), stroke)
        ...
        title_y = thumb_y + 10
        info_y = title_y + int(thumb_size * 0.25)
        duration_y = info_y + int(thumb_size * 0.25)
        icons_y = duration_y + 30  
        ...
        info_font = ImageFont.truetype("SONALI_MUSIC/assets/font.ttf", 20)
        ...
        # Duration text smaller
        draw.text((bar_x, bar_y + 7), "00:00", fill=(200,200,200), font=duration_font)
        draw.text((bar_x + bar_length - 80, bar_y + 7), f"{duration_text} 🎵", fill=(200,200,200), font=duration_font)
